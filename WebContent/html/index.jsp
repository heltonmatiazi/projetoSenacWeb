                            ...
                            <div class="form-section" id="form_1">
                                ...
                                <div class="section-content">
                                    <div class="form-master">
                                        <form method="POST" action="../ServletControle?cmd=upload" enctype="multipart/form-data" >
                                ...
                                <div class="section-content">
                                    <div class="form-master">                                       
                                           <div class="pesquisar-egresso">
                                                ...
                                                <form action="../ServletControle?cmd=pesquisar&param=1" method="post">
                                                ...
                                                <div class="form-group">
                                                <form action="../ServletControle?cmd=pesquisar&param=2" method="post">
                                                ...
                                                <div class="form-group">
                                                <form action="../ServletControle?cmd=pesquisar&param=3" method="post">
                                                ...
                                                <div class="form-group">
                                                <form action="../ServletControle?cmd=pesquisar&param=4" method="post" >
                                                ...
                                                <div class="form-group">
                                                <form action="../ServletControle?cmd=pesquisar&param=5" method="post">
                                                ...
                                                <div class="form-group">
                                                <form action="../ServletControle?cmd=pesquisar&param=6" method="post">
...
<!--                                <div class="section-content"> -->
<!--                                    <div class="form-master"> -->
<%--                                        <form method="POST" action="${pageContext.request.contextPath}/ServletControle?cmd=Alterar"> --%>
...
<!--                                <div class="section-content"> -->
<!--                                    <div class="form-master"> -->
<%--                                        <form method="POST" action="${pageContext.request.contextPath}/ServletControle?cmd=Excluir"> --%>
